...
public class ControladorTodo {
	...
	public String showAddTodoPage(ModelMap model) {
		model.addAttribute("todo", new Materias());
		return "todo";
	}

	@RequestMapping(value = "/add-todo", method = RequestMethod.POST)
	public String addTodo(ModelMap model, @Valid Materias todo, BindingResult result) {
	...
	public String showUpdateTodoPage(@RequestParam long id, ModelMap model) {
		Materias todo = todoService.getTodoById(id).get();
		model.put("todo", todo);
		return "todo";
	}

	@RequestMapping(value = "/update-todo", method = RequestMethod.POST)
	public String updateTodo(ModelMap model, @Valid Materias todo, BindingResult result) {
